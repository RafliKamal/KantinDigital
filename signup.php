...
<body>
    <div class="login">
        ...
        <h2 class="putih">Create new account</h2>
        <br>
        <form action="signup-proses.php" method="POST" >
          <div class="form-floating mb-4 mt-3 form tengah">
            <input type="text" class="form-control" id="floatingInput" placeholder="Masukan Nama" name="name">
        ...
        <input type="submit" value="Continue" name="signup"  class="tombol rounded-4">
      </form>
