<?php
include "db.php";
$tampil = mysqli_query($koneksi, "Select * from tb_metodebayar");
...
<body>
    ...
    <div class="inti">
        <h2 class="title">Data Metode Pembayaran</h2>
        ...
        <div class="modal-dialog">
            ...
            <form action="input-metode.php" method="POST" enctype="multipart/form-data">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="metodeid" name="metodeid">
                        <label for="floatingInput">Metode ID</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="nama" name="nama_metode">
            ...
            <table class="table table-striped text-center">
                <tr class="fw-semibold">
                    ...
                    {?>
                        ...
                        <td><?php echo $a['nama_metode']?></td>
                        <td>
                            <a href="hapus-metode.php?metode_id=<?php echo $a['metode_id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Kamu Yakin?')">Delete</a>
                            <a href="edit-metode.php?metode_id=<?php echo $a['metode_id']; ?>" class="btn btn-warning" style="margin-left: 5px;  padding: 7px 24px;">Edit</a>
                        </td>
                        </tr>
                <?php
                    }
